...
def createTicketMessageComponents(author: Member, colour: Colour, disabled: bool = False) -> Any:
    components = [
        ui.Container(
            ...
            ui.Separator(),
            ui.TextDisplay(content=f"📝 **Ticket example:**\n```Hello! I have some problem with...\nA member insulted me, please help me...\nThis bot is not working, where can I write an issue?..```"),
            ui.Separator(),
            ui.ActionRow(
                ui.Button(
